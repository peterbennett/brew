class StlinuxArmv7Autoconf < Formula
  ...
  def install
    ...
    bin.install_symlink "#{stdir}/bin/armv7-linux-autoconf" => "armv7-linux-autoconf"
    bin.install_symlink "#{stdir}/bin/armv7-linux-autoheader" => "armv7-linux-autoheader"
    bin.install_symlink "#{stdir}/bin/armv7-linux-autom4te" => "armv7-linux-autom4te"
    bin.install_symlink "#{stdir}/bin/armv7-linux-autoreconf" => "armv7-linux-autoreconf"
    bin.install_symlink "#{stdir}/bin/armv7-linux-autoscan" => "armv7-linux-autoscan"
    bin.install_symlink "#{stdir}/bin/armv7-linux-autoupdate" => "armv7-linux-autoupdate"
    bin.install_symlink "#{stdir}/bin/armv7-linux-ifnames" => "armv7-linux-ifnames"
  end

  test do
    system "stat #{stdir}/bin/armv7-linux-autoconf"
  end
end
